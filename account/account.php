...
<head>
    ...
    <title>Account Options - Hermes</title>
...
<body>
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                        <?php if (isset($_SESSION['logged_in']) && $_SESSION['logged_in'] === true) { ?>
                            ...
                            <hr class="breakpoint">
                            <a class="menu-item" href="account.php" id="AccountButton">Account</a>
                            <a class="menu-item" href="#" id="ServiceButton">Request a Service</a>
                            <a class="menu-item" href="../register_service/registerService.php">Register a Service</a>
                            <hr class="breakpoint">
    ...
    <div class="sidebar">
        <div class="account-options-container">
            <div class="account-option" data-url="personal_info.php">Personal Info</div>                <!-- TODO -->
            <div class="account-option" data-url="login_security.php">Login & Security</div>            <!-- TODO: Future -->
            <div class="account-option" data-url="payments_payouts.php">Payments & Payouts</div>        <!-- TODO: Future -->
            <div class="account-option" data-url="notifications.php">Notifications</div>                <!-- TODO: Future -->
            <div class="account-option" data-url="privacy.php">Privacy</div>                            <!-- TODO: Future -->
            <div class="account-option" data-url="preferences.php">Preferences</div>                    <!-- TODO: Future -->
        </div>
    </div>
    <div class="content">
