                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                        <?php if (isset($_SESSION['logged_in']) && $_SESSION['logged_in'] === true) { ?>
                            ...
                            <a class="menu-item" href="logout.php">Log out</a>
                        <?php } else { ?>
                ...
                <div id="loginModal" class="modal">
                    <div class="modal-content">
                        ...
                        <form action="login.php" method="POST">
                            <input type="email" placeholder="E-mail" class="input-field" name="email" id="emailField" required>
                ...
                <div id="SignUpModal" class="modal">
                    <div class="modal-content">
                        ...
                        <div class="password-field">
                            <input type="password" placeholder="Password" class="input-field" id="signUpPasswordField">
                        ...
                        <button class="sign-up-button" id="signUpButton">Sign up</button>
                        <div class="create-account-text">
                            <p>Don't have an account yet? <button class="create-account-button" id="createAccountButton">Create an account.</button></p>
                        </div>                        
                    </div>
